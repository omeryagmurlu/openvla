...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS]:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS & EEF_R6 & JOINT_POS actions supported!")
    ...
    if dataset_kwargs["action_encoding"] is ActionEncoding.EEF_POS:
        ...
        dataset_kwargs["absolute_action_mask"] = [True] * 7 + [True]
